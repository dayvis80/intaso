...
<div id="dcontenedor">
<h3 class='titulocontenedor'>CAJA - FLUJO X CAJEROS</h3>
<center>
   <div id="dinfo"> 
   <?php
   if (!$_POST){
...
<table class="tpinfo" style="width: 840px; padding:10px;">
   <tr><td><h3>INGRESAR DATOS</h3></td>
      <td>FECHA:</td>
      <td><input type="date" id="afxcfecha" class="textom"></td>
      <td><button id="bfxcmostrar" class="bsistema"><img src="../recursos/bflujo.png"/><span>DETALLES</span></button></td>
   </tr>
</table>
<?php  
}
