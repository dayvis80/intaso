...
<div id="dcontenedor">
<h3 class='titulocontenedor'>CAJA - INGRESOS A CAJA</h3>
...
<div id="dmodingresos" class="dmodalfondo">
   <div class="dmodalmensaje" style="width:320px;">
      <div class="dmodaltitulo">REGISTRAR NUEVO INGRESO          
      </div>
      <div class="dmodalcontenido">
         <table id="trsmodal">
         <tr class="separar">
            <td width="100px"><label>DETALLE:</label></td>
            <td width="150px"><input type="text" id="acicdetalle" class="textom" maxlength="35" required pattern="[0-9A-Za-z\s]+"></td>
         </tr>
          
         <tr class="separar">
            <td><label>TRABAJADOR:</label></td>
            <td width="150px"><select id="acictrabajador" class="opcionm">
            <?php
         ...
         <tr class="separar">
            ...
            <td><select id="acicmoneda" class="opcionm">
         ...
         <tr class="separar">
            ...
            <td><input type="text" id="acicmonto" class="textom"  maxlength="10" required></td>
         </tr class="separar">

         <tr class="separar">
            <td><label>DOCUMENTO:</label></td>
            <td><select id="acicdocumento" class="opcionm">
         ...
         <tr class="separar">
            ...
            <td><input type="text" id="acicnumero" class="textom" maxlength="9" pattern="[0-9]+"></td>
         </tr>

         <tr class="separar">
            <td><label>FECHA:</label></td>
            <td><input type="date" id="acicfechaineg" class="textom"></td>
         </tr>

         <tr class="separar">
            <td width="140px"><label>OBSERVACIONES:</label></td>
            <td><textarea id="acicobservaciones" class="textom" rows="5" cols="20"></textarea></td>
         </tr>
         </table>   
         <button id="bmodcicguardar" class="bsistema" style="float:left; margin: 15px 0px 0px 30px;"><img src="../recursos/bguardar.png"/><span>GUARDAR</span></button>
         <button id="bmodciccerrar" class="bsistema" style="float:right; margin: 15px 30px 0px 0px;"><img src="../recursos/bcancelar.png"/><span>CANCELAR</span></button>
      </div>
   </div>  
</div>
